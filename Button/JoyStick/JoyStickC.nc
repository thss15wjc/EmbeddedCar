...
module JoyStickP {
  provides interface AdcConfigure<const msp430adc12_channel_config_t*> as AdcConfigureX;
  provides interface AdcConfigure<const msp430adc12_channel_config_t*> as AdcConfigureY;
}
implementation {
